 ...
 function(a, b, c) {
     ...
     function r(a, b, e) {
         function f(b, c, d, e) {
             ...
             return p[b] = new U.Param(b,c,d,e),
             p[b]
         }
         function g(a, b, c, d) {
             var e = ["", ""]
     ...
     function t() {
         ...
         this.Param = function(a, d, e, f) {
             ...
             function r(a, b, d, e) {
                 ...
                 return f = P(a.replace) ? a.replace : [],
                 N(e) && f.push({
                     from: e,
                     to: c
                 }),
         ...
         function v(a, e, f, h, l, n, p, q, t) {
             ...
             y.transitionTo = function(b, c, f) {
                 ...
                 if (w(b, c, j, l, G, f))
                     ...
                     y.params = c,
                     S(y.params, n),
                     S(k(b.params.$$keys(), n), b.locals.globals.$stateParams),
                 ...
                 f.notify && a.$broadcast("$stateChangeStart", b.self, c, j.self, l, f).defaultPrevented)
                     ...
                     null == y.transition && p.update(),
                     C;
                 for (var J = e.when(G), K = D; K < z.length; K++,
                 F = z[K])
                     G = H[K] = d(G),
                     J = v(F, c, F === b, J, G, f);
                 var M = y.transition = J.then(function() {
                     ...
                     return y.transition !== M ? A : (y.transition = null,
     ...
     function G(a, c) {
         return {
             ...
             link: function(d, e, f, g) {
                 ...
                 n(),
                 k.clickable && (h = E(e, a, c, k, function() {
                     return j
                 }),
                 e.bind("click", h),
     ...
     function H(a, b) {
         return {
             ...
             link: function(c, d, e, f) {
                 ...
                 c.$watch(l, g, !0),
                 g(c.$eval(l)),
                 i.clickable && (h = E(d, a, b, i, function() {
                     return m
                 }),
                 d.bind("click", h),
         ...
         for (f = 0; i > f; f++) {
             ...
             if (k) {
                 var s = c[f + 1]
                   , t = f + 1 === h;
                 if (q === !1)
                     null != r && (j += P(r) ? o(r, b).join("-") : encodeURIComponent(r)),
                     j += s;
                 else if (q === !0) {
                     var u = j.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
                     j += s.match(u)[1]
     ...
     y.$inject = ["$state", "$injector", "$uiViewScroll", "$interpolate", "$q"],
     ...
     G.$inject = ["$state", "$timeout"],
     H.$inject = ["$state", "$timeout"],
     ...
     J.$inject = ["$state"],
     K.$inject = ["$state"],
     b.module("ui.router.state").filter("isState", J).filter("includedByState", K)
